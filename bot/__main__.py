...
def start(update, context):
    ...
    buttons.buildbutton("Bot Owner", "https://t.me/howtodoyt")
...
'''
        ...
        sendMarkup(
            'Oops! not a Authorized user.\nPlease deploy your own <b>mirrorbot</b>.',
            context.bot,
            update,
            reply_markup,
        )
...
help = Telegraph(access_token=telegraph_token).create_page(
        title='HTD Youtube Channel',
        author_name='HTD TECH VLOG',
        author_url='https://www.youtube.com/channel/UCohk_mpuW8SpgZMyOzRdKcA',
